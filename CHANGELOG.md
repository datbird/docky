...
Stop the fan for 0 RPM, readable focused fan buttons, and panel fixes from a UI pass
...
new release to remove HDR toggle from latest release.
...
[1.4.13]: https://github.com/datbird/docky/releases/tag/v1.4.13
